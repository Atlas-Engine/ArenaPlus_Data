...
--
-- Region eu, season 14, cutoffs last changed 2026-09-16 09:15 PM, last checked 2026-09-17 09:00 PM.
ns.CUTOFFS_BY_REGION = ns.CUTOFFS_BY_REGION or {}

ns.CUTOFFS_BY_REGION["eu"] = {
	region  = "eu",
	updated = "2026-09-16 09:15 PM",
	checked = "2026-09-17 09:00 PM",
	checkedEpoch = 1789693203,
...
ns.CUTOFF_SLOTS_BY_REGION["eu"] = {
	[1] = { r1=28, gladiator=203, duelist=515, rival=1857 }, -- 2v2
	[2] = { r1=28, gladiator=202, duelist=223, rival=278, challenger=536 }, -- 3v3
	[3] = { r1=20 }, -- 5v5
	[4] = { r1=5, duelist=23, rival=103, challenger=436 }, -- rbg
}
