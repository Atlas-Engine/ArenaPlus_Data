...
--
-- Region eu, season 14, cutoffs last changed 2026-09-16 09:15 PM, last checked 2026-09-16 10:00 PM.
ns.CUTOFFS_BY_REGION = ns.CUTOFFS_BY_REGION or {}

ns.CUTOFFS_BY_REGION["eu"] = {
	region  = "eu",
	updated = "2026-09-16 09:15 PM",
	checked = "2026-09-16 10:00 PM",
	checkedEpoch = 1789610424,
...
ns.CUTOFF_SLOTS_BY_REGION["eu"] = {
	[1] = { r1=28, gladiator=197, duelist=507, rival=1855 }, -- 2v2
	[2] = { r1=28, gladiator=201, duelist=223, rival=278, challenger=536 }, -- 3v3
	[3] = { r1=20 }, -- 5v5
