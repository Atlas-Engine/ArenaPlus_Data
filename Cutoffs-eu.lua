...
--
-- Region eu, season 14, cutoffs last changed 2026-09-21 09:14 PM, last checked 2026-09-22 09:00 PM.
ns.CUTOFFS_BY_REGION = ns.CUTOFFS_BY_REGION or {}

ns.CUTOFFS_BY_REGION["eu"] = {
	region  = "eu",
	updated = "2026-09-21 09:14 PM",
	checked = "2026-09-22 09:00 PM",
	checkedEpoch = 1790125207,
...
ns.CUTOFF_SLOTS_BY_REGION["eu"] = {
	[1] = { r1=28, gladiator=198, duelist=511, rival=1900 }, -- 2v2
	[2] = { r1=32, gladiator=202, duelist=226, rival=283, challenger=545 }, -- 3v3
	[3] = { r1=20 }, -- 5v5
