...
--
-- Region eu, season 14, cutoffs last changed 2026-09-06 09:25 PM, last checked 2026-09-07 02:55 PM.
ns.CUTOFFS_BY_REGION = ns.CUTOFFS_BY_REGION or {}

ns.CUTOFFS_BY_REGION["eu"] = {
	region  = "eu",
	updated = "2026-09-06 09:25 PM",
	checked = "2026-09-07 02:55 PM",
	checkedEpoch = 1788807336,
...
ns.CUTOFF_SLOTS_BY_REGION["eu"] = {
	[1] = { r1=28, gladiator=189, duelist=483, rival=1760 }, -- 2v2
	[2] = { r1=30, gladiator=190, duelist=208, rival=260, challenger=499 }, -- 3v3
	[3] = { r1=17 }, -- 5v5
