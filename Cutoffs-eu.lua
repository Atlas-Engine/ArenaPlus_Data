...
--
-- Region eu, season 14, cutoffs last changed 2026-09-19 09:14 PM, last checked 2026-09-20 04:00 PM.
ns.CUTOFFS_BY_REGION = ns.CUTOFFS_BY_REGION or {}

ns.CUTOFFS_BY_REGION["eu"] = {
	region  = "eu",
	updated = "2026-09-19 09:14 PM",
	checked = "2026-09-20 04:00 PM",
	checkedEpoch = 1789934409,
...
ns.CUTOFF_SLOTS_BY_REGION["eu"] = {
	[1] = { r1=27, gladiator=188, duelist=513, rival=1891 }, -- 2v2
	[2] = { r1=28, gladiator=202, duelist=226, rival=282, challenger=537 }, -- 3v3
	[3] = { r1=20 }, -- 5v5
