...
--
-- Region eu, season 14, cutoffs last changed 2026-09-07 09:25 PM, last checked 2026-09-08 04:55 PM.
ns.CUTOFFS_BY_REGION = ns.CUTOFFS_BY_REGION or {}

ns.CUTOFFS_BY_REGION["eu"] = {
	region  = "eu",
	updated = "2026-09-07 09:25 PM",
	checked = "2026-09-08 04:55 PM",
	checkedEpoch = 1788900919,
...
ns.CUTOFF_SLOTS_BY_REGION["eu"] = {
	[1] = { r1=28, gladiator=185, duelist=488, rival=1774 }, -- 2v2
	[2] = { r1=28, gladiator=192, duelist=210, rival=263, challenger=503 }, -- 3v3
	[3] = { r1=17 }, -- 5v5
