...
--
-- Region eu, season 14, cutoffs last changed 2026-09-24 09:18 PM, last checked 2026-09-25 08:00 PM.
ns.CUTOFFS_BY_REGION = ns.CUTOFFS_BY_REGION or {}

ns.CUTOFFS_BY_REGION["eu"] = {
	region  = "eu",
	updated = "2026-09-24 09:18 PM",
	checked = "2026-09-25 08:00 PM",
	checkedEpoch = 1790380806,
...
ns.CUTOFF_SLOTS_BY_REGION["eu"] = {
	[1] = { r1=30, gladiator=195, duelist=528, rival=1931 }, -- 2v2
	[2] = { r1=34, gladiator=207, duelist=227, rival=288, challenger=562 }, -- 3v3
	[3] = { r1=22 }, -- 5v5
