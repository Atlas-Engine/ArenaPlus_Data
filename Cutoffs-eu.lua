...
--
-- Region eu, season 14, cutoffs last changed 2026-09-25 09:18 PM, last checked 2026-09-26 01:00 PM.
ns.CUTOFFS_BY_REGION = ns.CUTOFFS_BY_REGION or {}

ns.CUTOFFS_BY_REGION["eu"] = {
	region  = "eu",
	updated = "2026-09-25 09:18 PM",
	checked = "2026-09-26 01:00 PM",
	checkedEpoch = 1790442007,
...
ns.CUTOFF_SLOTS_BY_REGION["eu"] = {
	[1] = { r1=30, gladiator=201, duelist=532, rival=1921 }, -- 2v2
	[2] = { r1=33, gladiator=208, duelist=228, rival=285, challenger=563 }, -- 3v3
	[3] = { r1=22 }, -- 5v5
