...
--
-- Region eu, season 14, cutoffs last changed 2026-09-17 09:14 PM, last checked 2026-09-18 06:00 PM.
ns.CUTOFFS_BY_REGION = ns.CUTOFFS_BY_REGION or {}

ns.CUTOFFS_BY_REGION["eu"] = {
	region  = "eu",
	updated = "2026-09-17 09:14 PM",
	checked = "2026-09-18 06:00 PM",
	checkedEpoch = 1789768808,
...
ns.CUTOFF_SLOTS_BY_REGION["eu"] = {
	[1] = { r1=28, gladiator=189, duelist=506, rival=1866 }, -- 2v2
	[2] = { r1=28, gladiator=202, duelist=224, rival=278, challenger=536 }, -- 3v3
	[3] = { r1=20 }, -- 5v5
