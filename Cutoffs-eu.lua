...
--
-- Region eu, season 14, cutoffs last changed 2026-09-23 09:18 PM, last checked 2026-09-24 09:00 PM.
ns.CUTOFFS_BY_REGION = ns.CUTOFFS_BY_REGION or {}

ns.CUTOFFS_BY_REGION["eu"] = {
	region  = "eu",
	updated = "2026-09-23 09:18 PM",
	checked = "2026-09-24 09:00 PM",
	checkedEpoch = 1790298002,
...
ns.CUTOFF_SLOTS_BY_REGION["eu"] = {
	[1] = { r1=29, gladiator=196, duelist=522, rival=1916 }, -- 2v2
	[2] = { r1=32, gladiator=206, duelist=229, rival=287, challenger=557 }, -- 3v3
	[3] = { r1=20 }, -- 5v5
