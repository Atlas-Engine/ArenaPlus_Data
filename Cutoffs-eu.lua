...
--
-- Region eu, season 14, cutoffs last changed 2026-09-21 09:14 PM, last checked 2026-09-23 08:00 PM.
ns.CUTOFFS_BY_REGION = ns.CUTOFFS_BY_REGION or {}

ns.CUTOFFS_BY_REGION["eu"] = {
	region  = "eu",
	updated = "2026-09-21 09:14 PM",
	checked = "2026-09-23 08:00 PM",
	checkedEpoch = 1790208006,
...
ns.CUTOFF_SLOTS_BY_REGION["eu"] = {
	[1] = { r1=30, gladiator=201, duelist=527, rival=1908 }, -- 2v2
	[2] = { r1=32, gladiator=205, duelist=227, rival=286, challenger=551 }, -- 3v3
	[3] = { r1=20 }, -- 5v5
