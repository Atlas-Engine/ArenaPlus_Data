...
--
-- Region eu, season 14, cutoffs last changed 2026-09-17 09:14 PM, last checked 2026-09-18 08:00 PM.
ns.CUTOFFS_BY_REGION = ns.CUTOFFS_BY_REGION or {}

ns.CUTOFFS_BY_REGION["eu"] = {
	region  = "eu",
	updated = "2026-09-17 09:14 PM",
	checked = "2026-09-18 08:00 PM",
	checkedEpoch = 1789776009,
...
ns.CUTOFF_SLOTS_BY_REGION["eu"] = {
	[1] = { r1=28, gladiator=189, duelist=508, rival=1871 }, -- 2v2
	[2] = { r1=28, gladiator=205, duelist=227, rival=281, challenger=537 }, -- 3v3
	[3] = { r1=20 }, -- 5v5
