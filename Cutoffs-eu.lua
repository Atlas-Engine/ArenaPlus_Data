...
--
-- Region eu, season 14, cutoffs last changed 2026-09-14 09:25 PM, last checked 2026-09-15 04:00 PM.
ns.CUTOFFS_BY_REGION = ns.CUTOFFS_BY_REGION or {}

ns.CUTOFFS_BY_REGION["eu"] = {
	region  = "eu",
	updated = "2026-09-14 09:25 PM",
	checked = "2026-09-15 04:00 PM",
	checkedEpoch = 1789502413,
...
ns.CUTOFF_SLOTS_BY_REGION["eu"] = {
	[1] = { r1=27, gladiator=204, duelist=515, rival=1850 }, -- 2v2
	[2] = { r1=32, gladiator=201, duelist=220, rival=275, challenger=531 }, -- 3v3
	[3] = { r1=19 }, -- 5v5
