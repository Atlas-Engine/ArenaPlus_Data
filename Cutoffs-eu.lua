...
--
-- Region eu, season 14, cutoffs last changed 2026-09-09 09:25 PM, last checked 2026-09-10 07:55 PM.
ns.CUTOFFS_BY_REGION = ns.CUTOFFS_BY_REGION or {}

ns.CUTOFFS_BY_REGION["eu"] = {
	region  = "eu",
	updated = "2026-09-09 09:25 PM",
	checked = "2026-09-10 07:55 PM",
	checkedEpoch = 1789084525,
...
ns.CUTOFF_SLOTS_BY_REGION["eu"] = {
	[1] = { r1=27, gladiator=192, duelist=503, rival=1798 }, -- 2v2
	[2] = { r1=32, gladiator=199, duelist=217, rival=269, challenger=510 }, -- 3v3
	[3] = { r1=17 }, -- 5v5
