...
--
-- Region eu, season 14, cutoffs last changed 2026-09-07 09:25 PM, last checked 2026-09-09 05:55 PM.
ns.CUTOFFS_BY_REGION = ns.CUTOFFS_BY_REGION or {}

ns.CUTOFFS_BY_REGION["eu"] = {
	region  = "eu",
	updated = "2026-09-07 09:25 PM",
	checked = "2026-09-09 05:55 PM",
	checkedEpoch = 1788990934,
...
ns.CUTOFF_SLOTS_BY_REGION["eu"] = {
	[1] = { r1=28, gladiator=191, duelist=497, rival=1787 }, -- 2v2
	[2] = { r1=28, gladiator=193, duelist=211, rival=267, challenger=505 }, -- 3v3
	[3] = { r1=17 }, -- 5v5
