...
--
-- Region eu, season 14, cutoffs last changed 2026-09-21 09:14 PM, last checked 2026-09-23 03:00 AM.
ns.CUTOFFS_BY_REGION = ns.CUTOFFS_BY_REGION or {}

ns.CUTOFFS_BY_REGION["eu"] = {
	region  = "eu",
	updated = "2026-09-21 09:14 PM",
	checked = "2026-09-23 03:00 AM",
	checkedEpoch = 1790146803,
...
ns.CUTOFF_SLOTS_BY_REGION["eu"] = {
	[1] = { r1=29, gladiator=198, duelist=511, rival=1900 }, -- 2v2
	[2] = { r1=32, gladiator=202, duelist=226, rival=284, challenger=547 }, -- 3v3
	[3] = { r1=20 }, -- 5v5
