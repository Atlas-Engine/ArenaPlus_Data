...
--
-- Region tbc-eu, season 3, cutoffs last changed 2026-09-21 09:14 PM, last checked 2026-09-23 08:59 AM.
ns.CUTOFFS_BY_REGION = ns.CUTOFFS_BY_REGION or {}

ns.CUTOFFS_BY_REGION["tbc-eu"] = {
	region  = "tbc-eu",
	updated = "2026-09-21 09:14 PM",
	checked = "2026-09-23 08:59 AM",
	checkedEpoch = 1790168342,
...
ns.CUTOFF_SLOTS_BY_REGION["tbc-eu"] = {
	[1] = { r1=38, gladiator=241, duelist=1498 }, -- 2v2
	[2] = { r1=21, gladiator=168, duelist=936, rival=3648 }, -- 3v3
	[3] = { r1=78, gladiator=494, duelist=3071 }, -- 5v5
}
