...
--
-- Region tbc-eu, season 3, cutoffs last changed 2026-09-14 09:21 PM, last checked 2026-09-15 03:59 AM.
ns.CUTOFFS_BY_REGION = ns.CUTOFFS_BY_REGION or {}

ns.CUTOFFS_BY_REGION["tbc-eu"] = {
	region  = "tbc-eu",
	updated = "2026-09-14 09:21 PM",
	checked = "2026-09-15 03:59 AM",
	checkedEpoch = 1789459166,
...
ns.CUTOFF_SLOTS_BY_REGION["tbc-eu"] = {
	[1] = { r1=32, gladiator=194, duelist=1239, rival=4804 }, -- 2v2
	[2] = { r1=22, gladiator=139, duelist=772, rival=2943 }, -- 3v3
	[3] = { r1=63, gladiator=414, duelist=2690 }, -- 5v5
}
