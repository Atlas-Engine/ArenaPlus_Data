...
--
-- Region tbc-eu, season 3, cutoffs last changed 2026-09-16 09:14 PM, last checked 2026-09-17 06:59 AM.
ns.CUTOFFS_BY_REGION = ns.CUTOFFS_BY_REGION or {}

ns.CUTOFFS_BY_REGION["tbc-eu"] = {
	region  = "tbc-eu",
	updated = "2026-09-16 09:14 PM",
	checked = "2026-09-17 06:59 AM",
	checkedEpoch = 1789642767,
...
ns.CUTOFF_SLOTS_BY_REGION["tbc-eu"] = {
	[1] = { r1=34, gladiator=218, duelist=1350 }, -- 2v2
	[2] = { r1=24, gladiator=138, duelist=828, rival=3166 }, -- 3v3
	[3] = { r1=66, gladiator=435, duelist=2883 }, -- 5v5
}
