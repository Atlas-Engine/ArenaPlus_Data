...
--
-- Region us, season 14, cutoffs last changed 2026-09-07 10:15 AM, last checked 2026-09-07 05:00 PM.
...
ns.CUTOFF_SLOTS_BY_REGION["us"] = {
	[1] = { r1=32, gladiator=204, duelist=501, rival=1656 }, -- 2v2
	[2] = { r1=23, gladiator=189, duelist=221, rival=314, challenger=646 }, -- 3v3
	[3] = { r1=15, gladiator=113, duelist=119, rival=137, challenger=198 }, -- 5v5
	[4] = { r1=3, duelist=7, rival=24, challenger=118 }, -- rbg
}
