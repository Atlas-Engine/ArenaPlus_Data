...
--
-- Region us, season 14, cutoffs last changed 2026-09-11 10:15 AM, last checked 2026-09-11 11:00 PM.
...
ns.CUTOFF_SLOTS_BY_REGION["us"] = {
	[1] = { r1=29, gladiator=203, duelist=505, rival=1673 }, -- 2v2
	[2] = { r1=23, gladiator=188, duelist=215, rival=315, challenger=649 }, -- 3v3
	[3] = { r1=15, gladiator=112, duelist=115, rival=135, challenger=200 }, -- 5v5
	[4] = { r1=3, duelist=8, rival=24, challenger=120 }, -- rbg
}
