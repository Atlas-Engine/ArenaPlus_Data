...
--
-- Region us, season 14, cutoffs last changed 2026-09-14 10:15 AM, last checked 2026-09-16 04:57 AM.
...
ns.CUTOFF_SLOTS_BY_REGION["us"] = {
	[1] = { r1=25, gladiator=210, duelist=514, rival=1723 }, -- 2v2
	[2] = { r1=25, gladiator=193, duelist=219, rival=313, challenger=657 }, -- 3v3
	[3] = { r1=13, gladiator=116, duelist=119, rival=141, challenger=208 }, -- 5v5
