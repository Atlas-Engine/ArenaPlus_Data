...
--
-- Region us, season 14, cutoffs last changed 2026-09-23 10:18 AM, last checked 2026-09-24 12:59 AM.
...
ns.CUTOFF_SLOTS_BY_REGION["us"] = {
	[1] = { r1=30, gladiator=208, duelist=537, rival=1778 }, -- 2v2
	[2] = { r1=25, gladiator=184, duelist=219, rival=320, challenger=675 }, -- 3v3
	[3] = { r1=15, gladiator=113, duelist=123, rival=139, challenger=223 }, -- 5v5
