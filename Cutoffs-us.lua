...
--
-- Region us, season 14, cutoffs last changed 2026-09-20 10:14 AM, last checked 2026-09-21 04:59 AM.
...
ns.CUTOFF_SLOTS_BY_REGION["us"] = {
	[1] = { r1=30, gladiator=211, duelist=535, rival=1747 }, -- 2v2
	[2] = { r1=26, gladiator=184, duelist=226, rival=320, challenger=673 }, -- 3v3
	[3] = { r1=19, gladiator=114, duelist=121, rival=144, challenger=210 }, -- 5v5
