...
--
-- Region us, season 14, cutoffs last changed 2026-08-30 10:30 AM, last checked 2026-08-31 05:00 AM.
...
ns.CUTOFF_SLOTS_BY_REGION["us"] = {
	[1] = { r1=34, gladiator=205 }, -- 2v2
	[2] = { r1=24, gladiator=193 }, -- 3v3
	[3] = { r1=15, gladiator=115 }, -- 5v5
	[4] = { r1=3 }, -- rbg
}
